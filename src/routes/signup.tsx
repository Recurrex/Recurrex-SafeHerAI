...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Sign Up — SafeHer AI" },
      { name: "description", content: "Create your free SafeHer AI account and start protecting yourself today." },
      ...
      <section className="container mx-auto flex min-h-[80vh] items-center justify-center px-4 py-12 md:px-6">
        <div className="glass w-full max-w-md rounded-3xl p-8 shadow-glow">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Start your safety journey in seconds</p>
          </div>
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" required minLength={6} value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="pl-9" />
              </div>
            </div>
          ...
          <Button variant="outline" className="w-full" onClick={async () => {
            try { await signInGoogle(); toast.success("Signed in!"); navigate({ to: "/dashboard" }); }
