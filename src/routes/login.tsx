...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Login — SafeHer AI" },
      { name: "description", content: "Sign in to your SafeHer AI account." },
      ...
      <section className="container mx-auto flex min-h-[80vh] items-center justify-center px-4 py-12 md:px-6">
        <div className="glass w-full max-w-md rounded-3xl p-8 shadow-glow">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Sign in to your SafeHer AI account</p>
          </div>
